...
import { SipComponent, SipNgDestroy } from '../../help/sip-helper';
import { SipRestSqlRet, SipSqlParam } from '../../services/sip-rest.service';
...
export interface ISipMinitableManager<T=any> {
    ...
    /**快捷菜单定义 */
    contextmenu?: (this: SipMinitableManager<T>, menu: ISipContextMenu, row: SipMiniTableRow<T>[]) => void;
